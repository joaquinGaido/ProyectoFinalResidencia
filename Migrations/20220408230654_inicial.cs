        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Rama = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RamaEspecialidad", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Uder = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Jusgado = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    TratamientoMedico = table.Column<bool>(type: "bit", nullable: false),
                    TratamientoPsicologico = table.Column<bool>(type: "bit", nullable: false),
                    Medicamento = table.Column<bool>(type: "bit", nullable: false),
                    ReevinculacionesFamiliares = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    familiaId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Adolecentes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Adolecentes_Familias_familiaId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ramasId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Empleados_RamaEspecialidad_ramasId",
                        column: x => x.ramasId,
                        principalTable: "RamaEspecialidad",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });

            migrationBuilder.CreateIndex(
                name: "IX_Adolecentes_familiaId",
                table: "Adolecentes",
                column: "familiaId");
